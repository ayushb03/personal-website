...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const titles = {
    'en': 'Ayush Bodade - AI Engineer & Researcher',
    'zh-cn': 'Ayush Bodade - 人工智能工程师与研究员',
    'fr': 'Ayush Bodade - Ingénieur IA & Chercheur',
    'de': 'Ayush Bodade - KI-Ingenieur & Forscher',
    'es': 'Ayush Bodade - Ingeniero de IA e Investigador',
    'it': 'Ayush Bodade - Ingegnere AI e Ricercatore',
  };

  const descriptions = {
    'en': 'Ayush Bodade is an AI Engineer and Researcher specializing in multi-agent systems, machine learning, and reinforcement learning with experience at QX Labs, Unsiloed AI, MIT, and IIT Bombay.',
    'zh-cn': 'Ayush Bodade 是一位人工智能工程师和研究员，专门研究多智能体系统、机器学习和强化学习，在 QX Labs、Unsiloed AI、MIT 和 IIT Bombay 有丰富经验。',
    'fr': 'Ayush Bodade est un ingénieur IA et chercheur spécialisé dans les systèmes multi-agents, l\'apprentissage automatique et l\'apprentissage par renforcement avec une expérience chez QX Labs, Unsiloed AI, MIT et IIT Bombay.',
    'de': 'Ayush Bodade ist ein KI-Ingenieur und Forscher, der sich auf Multi-Agenten-Systeme, maschinelles Lernen und verstärktes Lernen spezialisiert hat, mit Erfahrung bei QX Labs, Unsiloed AI, MIT und IIT Bombay.',
    'es': 'Ayush Bodade es un ingeniero de IA e investigador especializado en sistemas multi-agente, aprendizaje automático y aprendizaje por refuerzo con experiencia en QX Labs, Unsiloed AI, MIT e IIT Bombay.',
    'it': 'Ayush Bodade è un ingegnere AI e ricercatore specializzato in sistemi multi-agente, machine learning e apprendimento per rinforzo con esperienza presso QX Labs, Unsiloed AI, MIT e IIT Bombay.',
  };
